        ...
        <div className="grid md:grid-cols-[55fr_45fr] gap-16 items-center">
          <div>
            ...
            <div className="flex flex-wrap items-center gap-4 mb-8">
              <Link
                href="#contact"
                className="inline-flex items-center justify-center px-6 md:px-8 py-3 border-2 text-slate-300 font-medium bg-blue-600 border-blue-600 rounded-lg transition-all duration-300 hover:bg-blue-700 hover:border-blue-700 hover:shadow-[0_0_2rem] hover:shadow-blue-500/40 hover:-translate-y-1"
              >
                Contact Me
              </Link>
              <Link
                href="#projects"
                className="inline-flex items-center justify-center px-6 md:px-8 py-3 border-2 text-blue-400 font-medium border-blue-600 rounded-lg transition-all duration-300 hover:bg-blue-600 hover:text-white hover:shadow-[0_0_2rem] hover:shadow-blue-500/40 hover:-translate-y-1"
              >
                View Projects
              </Link>
              ...
              <Link
                ...
                target="_blank"
                className="inline-flex items-center justify-center px-6 md:px-8 py-3 border-2 text-slate-300 font-medium bg-blue-600  border-blue-600 rounded-lg transition-all duration-300 hover:border-blue-700 hover:bg-blue-700 hover:shadow-[0_0_2rem] hover:shadow-blue-500/40 hover:-translate-y-1"
              >
                Resume
              </Link>
            </div>
